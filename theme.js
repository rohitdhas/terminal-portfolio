...
const secrets = () => {
  if (secret === 0) {
    ...
    terminal.insertAdjacentHTML(
      "beforeend",
      `<p class="result">
          You have activated additional themes! Use the command <code>themes</code> to see new
          themes. 
        </p>`
    );
    secret = 1;
    ...
    terminal.insertAdjacentHTML(
      "beforeend",
      `<p class="result">
          Secret themes are already active. Use the command <code>themes</code> to see themes. 
        </p>`
    );
  }
};
