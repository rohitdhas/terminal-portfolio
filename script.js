...
function logKey(e) {
  ...
  if (e.key === "Tab") {
    if (y === -1) {
      ...
      if (result.includes("cd r")) {
        input.value = "cd Rohit\\ Dhas/";
      }
      ...
      if (result.includes("get r")) {
        input.value = "get resume";
      }
    ...
    if (result === "") {
      ...
      if (y === -1) {
        if (
          ...
          terminal.insertAdjacentHTML(
            "beforeend",
            `<p class="not found result">${result}: command not found</p>`
          );
        }
      } else if (y === 0) {
        if (result === "help") {
          ...
          terminal.insertAdjacentHTML(
            "beforeend",
            `<p class="not found result">${result}: command not found
      ...
      if (y === -1) {
        ...
        terminal.insertAdjacentHTML(
          "beforeend",
          `<p class="commande" id="answer${i}">Rohit Dhas:~$:</p><input type="text" autofocus class="input themeinput" id="input${i}" tabindex="-1">`
        );
      } else if (y === 1) {
        terminal = document.getElementById("terminal");
        terminal.insertAdjacentHTML(
          "beforeend",
          `<p class="commande" id="answer${i}">Rohit Dhas:~/portfolio/themes$:</p><input type="text" autofocus class="input themeinput" id="input${i}" tabindex="-1">`
        );
      } else {
        terminal = document.getElementById("terminal");
        terminal.insertAdjacentHTML(
          "beforeend",
          `<p class="commande" id="answer${i}">Rohit Dhas:~/portfolio$</p><input type="text" autofocus class="input" id="input${i}" tabindex="-1">`
        );
      }
      document.getElementById(`input${i}`).focus();
      if (
